...
# db = client['polytest']  # make sure this is the correct DB name
# markets_col = db['markets']  # collection
...
#         {"id": m["id"]},  # match by market ID
#         {"$set": m},      # update or insert the whole object
#         upsert=True
#     )
